...
import { Calculator, Car, Sparkles, Settings } from "lucide-react";
...
function FleetPage() {
  ...
  const vehicles = useMemo(() => {
    const list = getPublishedVehicles();
          ...
          <div className="mt-8 space-y-6">
            <div className="flex flex-wrap items-center justify-between gap-3 bg-card p-4 rounded-xl border">
              <p className="text-sm font-semibold text-foreground" role="status">
                <span className="text-orange-600 font-bold">{vehicles.length}</span> vehicles available
              </p>
              <div className="flex items-center gap-2">
                <label htmlFor="fleet-sort" className="text-xs font-semibold text-muted-foreground">
                  Sort by:
                </label>
                <select
                  id="fleet-sort"
                  ...
                  className="h-10 rounded-lg border border-input bg-background px-3 text-sm font-medium focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
                >
            ...
            {vehicles.length === 0 ? (
              <div className="rounded-xl border border-dashed border-border p-10 text-center">
                <h3 className="text-base font-bold">No vehicles currently available</h3>
                <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
                  If you need something specific, our team can arrange it — call {company.phone} and we'll find the right vehicle.
                </p>
