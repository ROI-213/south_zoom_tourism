...
const sharedPolicies = (pkg: {
  ...
  inclusions: [
    `${pkg.nights} nights accommodation in a ${pkg.hotelCategory} property on twin sharing`,
    "Daily breakfast at the hotel",
    `${pkg.vehicleCategory} with a professional driver for the full itinerary`,
    "Toll, parking, fuel, driver bata and interstate permits",
    "All applicable taxes on the quoted components",
    "24/7 trip coordinator on WhatsApp during travel",
  ],
  exclusions: [
    "Lunch, dinner and anything not listed under inclusions",
    "Monument, safari, boating and entry tickets",
    "Guide charges and camera fees at heritage sites",
    "Personal expenses, tips and travel insurance",
    "Any cost arising from roadblocks, strikes or weather delays",
    "Air, rail or bus tickets to and from the starting city",
  ],
  terms: [
    "Rates are an estimate and are confirmed in writing before payment.",
    "Hotel names may be swapped for a similar category property on sold-out dates.",
    "Vehicle is provided as per the itinerary and is not at disposal overnight.",
    "Check-in is normally 2 PM and check-out 11 AM unless stated otherwise.",
    "Valid government photo ID is required at every hotel check-in.",
  ],
  "child-policy": [
    "Children below 5 years travel free without a separate bed or seat.",
    "Children between 5 and 11 years are charged 60% of the adult rate with a shared bed.",
    "Children 12 years and above are charged as adults.",
    "An extra bed or extra room is quoted separately on request.",
  ],
  "payment-policy": [
    "25% advance to confirm the booking and block hotels.",
    "50% due seven days before the travel date.",
    "Balance payable on the first day of travel before departure.",
    "Peak-season and festival departures may need a full advance.",
    "A GST invoice is issued for every payment received.",
  ],
  "cancellation-policy": [
    "Cancelled 15 days or more before travel — full refund less transaction charges.",
    "Cancelled 7 to 14 days before travel — 25% of the package value is retained.",
    "Cancelled 3 to 6 days before travel — 50% of the package value is retained.",
    "Cancelled within 48 hours or a no-show — no refund.",
